...
1. What is the purpose of using _sessions_?
    ...
    So you don't have to log in to each page that you visit.

1. What does bcrypt do to help us store passwords in a secure manner.

    It is a password hashing function so the password is stored as a hash instead of what the password actually is.  

1. What does bcrypt do to slow down attackers?

    It hashes the password  and incorporates a salt to protect from rainbow attacks.
